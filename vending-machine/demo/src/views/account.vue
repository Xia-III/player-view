<template>
    <div class="top">
        ...
        <ul class="list">
            ...
            <li v-if="isCoin === false">余额：{{ playerProfile.coins / 100 }}</li>
            <!-- <li v-if="isCoin === false">总币数：{{ Math.floor(playerProfile.coinsBindTotal1 / playerProfile.coinFee) }}</li> -->
            <li v-else>余币：{{ Math.floor((playerProfile.coins + playerProfile.coinsBind) / 100) }}</li>
