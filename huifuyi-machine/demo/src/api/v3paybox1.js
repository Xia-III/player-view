...
export const GetTestMachineCoins = params => request({
    method: 'GET',
    url: washing + 'api/GetTestMachineCoins',
    params
})
// 测试投币(OnlineCoinInTest)
export const OnlineCoinInTest = params => request({
    method: 'GET',
    url: washing + 'api/OnlineCoinInTest',
    params
})