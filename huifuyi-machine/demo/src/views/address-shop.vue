<template>
    ...
    <div class="addressShop">
        <div class="item" v-for="(item, index) in addressIdList" :key="index">
            ...
            <van-button type="success" v-if="item.addressId != addressId" @click="activeMachine(item)">切换当前场地</van-button>
        ...
        await v3PlayerChangeAddressAPI({
            ...
            if (res.data.code == 200) {
                ...
                showDialog({
                    ...
                    location.href = `https://www.huanxizn.com/newwashing/#/login/?machineId=null&extId=0`;
                });
