...
const getDataFee = async () => {
  ...
  if (
    ...
    if (
      ...
      ticketId.value = localStorage.getItem("ticketId");
    }
  } else {
  ...
  // window.location.href = "https://" + host + "/newcoiner/#/qrcodeAuthlogin";
  router.replace({ name: "qrcodeAuthlogin" });
  // window.location.href = res.data.data + "/index.html#/qrcodeAuthlogin";
};
