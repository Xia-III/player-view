...
const getDataFee = async () => {
  ...
  if (
    urlParams.value["machineId"] == "" ||
    urlParams.value["machineId"] == undefined ||
    urlParams.value["machineId"] == null
  ) {
    if (
      localStorage.getItem("shop_starterMachineId") == "" ||
      localStorage.getItem("shop_starterMachineId") == undefined ||
      localStorage.getItem("shop_starterMachineId") == null
    ) {
      ...
      if (localStorage.getItem("fee")) {
        fee.value = localStorage.getItem("fee");
      }
    }
  } else {
