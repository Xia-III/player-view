...
import {
  ...
  v3PlayerCoinIn,
  v3PlayerPlaceOrder,
  v3PlayerRechargeConfigList,
  v3PlayerRecharge,
  v3PlayerCoinList,
  v3PlayerChangeAddress,
  v3PlayerDouYinVerify,
  v3PlayerMeituanVerify,
  GetTestMachineCoins,
  OnlineCoinInTest,
  v3PlaceOrder,
  PlayerTicketAuth,
...
import {
  JsApiConfig,
  GetComplaintMessagePageList,
  SaveComplaintMessage,
} from "./v2center1.js";
// v3paybox1相关接口：
...
export const v3PlayerDouYinVerifyAPI = v3PlayerDouYinVerify;
export const v3PlayerMeituanVerifyAPI = v3PlayerMeituanVerify;
...
export const v3PlaceOrderAPI = v3PlaceOrder;
